...
#  This script takes any audio or a/v file, of any resolution, and converts it to a stereo mp3 file at 320k.
...
modulename="Audio file to .mp3 Conversion Script"
SOURCEPATH="$1"
FILENAME="$2"
# Get rid of file .SUFFIX
LENGTH=${#FILENAME}
outputfile="/video/${FILENAME:0:$LENGTH-4}.mp3"

#FFMPEG vars
vidopts=""
audopts="-acodec mp3 -ar 320k"
